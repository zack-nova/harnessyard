...
assert_contains_line "$quickstart_doc" "hyard plumbing harness bootstrap complete --orbit <orbit-id>"
assert_contains_line "$quickstart_doc" "hyard plumbing harness bootstrap reopen --orbit <orbit-id>"
